...
time.sleep(20)
frames = WebDriverWait(driver, 20).until(find_elements(By.TAG_NAME, "iframe"))
...
ts = WebDriverWait(driver, 30).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="recaptcha-audio-button"]')))
time.sleep(5)
ts.click()
driver.switch_to.default_content()
